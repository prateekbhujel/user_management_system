    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 mt-3">
            <?php if($verified == 'verified'):?>
                <div class="card-border-warning">
                    ...
                    <div class="card-body">
                        <form action = "#" method= "post" class = "px-4" id= "feedback-form">
                            ...
                            <div class="form-group">
                                    <textarea name="feedback" id="" class="form-control-lg form-control rounded-0" rows="8" palceholder="Write your feedback here or message ... .. . " required></textarea>
                            </div>
                ...
                <?php else: ?>
                    <h1 class="text-center text-danger mt-5"> Your Email Should be verfied to send Feedback to Admin.</h1>
                <?php endif; ?>
        </div>
    </div>
   </div>
